...
# Task 1C (Challenge):
# Create a function called countdown that prints:
# 3
# 2
# 1
# Go!
...
# 1. calculate_score(score) → returns score + 5
# 2. spawn_enemy(num) → prints: Enemy <num> appeared!
# 3. game_round(score):
#    - use a loop to spawn 3 enemies
#    - update the score using calculate_score
